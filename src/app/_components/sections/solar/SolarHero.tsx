...
export function SolarHero() {
  return (
    <section
      id="top"
      className="relative left-1/2 right-1/2 -mx-[50vw] w-screen overflow-x-clip border-b border-slate-200/80 bg-[#0a1628] pt-28 pb-10 text-white md:pt-40 md:pb-14"
    >
