...
export function GeneratorsHero() {
  return (
    <section
      id="top"
      className="relative left-1/2 right-1/2 -mx-[50vw] w-screen overflow-x-clip border-b border-slate-200/80 bg-[#0a1628] pt-28 pb-14 text-white md:pt-40 md:pb-20"
    >
      ...
      <div className="app-container relative z-10">
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-white/60">
          Generadores y respaldo ENERGRUN
        </p>
